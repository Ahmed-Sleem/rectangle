...
- Toggle controls: compact desktop targets placed with their owning chrome: menu toggle sits above the profile/account section; AI launcher sits in the canvas corner.
