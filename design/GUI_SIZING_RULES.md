...
- Toggle controls: compact desktop targets placed in the main canvas corners: menu toggle is a black 36px circular bottom-left canvas control with visible border/inner ring; AI launcher is a black 36px circular top-right canvas control.
