...
const en = {
  ...
  kpiDueSoon_one: "Due within a day",
  kpiDueSoon_other: "Due within {{count}} days",
  kpiDueSoonHint_one: "{{count}} already overdue",
  kpiDueSoonHint_other: "{{count}} already overdue",
  kpiRisks: "Risk exposure",
  kpiRisksHint_one: "{{count}} critical or high",
  kpiRisksHint_other: "{{count}} critical or high",
  kpiTeam: "People",
...
const ar: LocaleBundle<typeof en> = {
  ...
  kpiDueSoon_zero: "مستحق خلال {{count}} يوم",
  kpiDueSoon_one: "مستحق خلال يوم",
  kpiDueSoon_two: "مستحق خلال يومين",
  kpiDueSoon_few: "مستحق خلال {{count}} أيام",
  kpiDueSoon_many: "مستحق خلال {{count}} يومًا",
  kpiDueSoon_other: "مستحق خلال {{count}} يوم",
  kpiDueSoonHint_zero: "لا مهام متأخرة",
  kpiDueSoonHint_one: "مهمة واحدة متأخرة",
  kpiDueSoonHint_two: "مهمتان متأخرتان",
  kpiDueSoonHint_few: "{{count}} مهام متأخرة",
  kpiDueSoonHint_many: "{{count}} مهمة متأخرة",
  kpiDueSoonHint_other: "{{count}} مهمة متأخرة",
  kpiRisks: "التعرّض للمخاطر",
  kpiRisksHint_zero: "لا مخاطر حرجة أو عالية",
  kpiRisksHint_one: "خطر واحد حرج أو عالٍ",
  kpiRisksHint_two: "خطران حرجان أو عاليان",
  kpiRisksHint_few: "{{count}} مخاطر حرجة أو عالية",
  kpiRisksHint_many: "{{count}} خطرًا حرجًا أو عاليًا",
  kpiRisksHint_other: "{{count}} خطر حرج أو عالٍ",
  kpiTeam: "الأشخاص",
